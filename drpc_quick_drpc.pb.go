...
type drpcEncoding_File_drpc_quick_proto struct{}

func (drpcEncoding_File_drpc_quick_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_drpc_quick_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
	return proto.MarshalOptions{}.MarshalAppend(buf, msg.(proto.Message))
}

func (drpcEncoding_File_drpc_quick_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_drpc_quick_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return protojson.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_drpc_quick_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcCookieMonsterClient) EatCookie(ctx context.Context, in *Cookie) (*Crumbs, error) {
	out := new(Crumbs)
	err := c.cc.Invoke(ctx, "/sesamestreet.CookieMonster/EatCookie", drpcEncoding_File_drpc_quick_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCCookieMonsterDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/sesamestreet.CookieMonster/EatCookie", drpcEncoding_File_drpc_quick_proto{},
...
func (x *drpcCookieMonster_EatCookieStream) SendAndClose(m *Crumbs) error {
	if err := x.MsgSend(m, drpcEncoding_File_drpc_quick_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
